...
def purchase_a_sword():
    """Includes a POST method so that users can post metadata characteristics of an event"""
...
def main():
    """main
       Use Spark streaming to filter event types from Kafka, land them into HDFS/parquet
       Processing time interval is set to 10 seconds.
    """
    spark = SparkSession \
        .builder \
